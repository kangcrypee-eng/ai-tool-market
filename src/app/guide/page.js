...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      { q: '무료 기간이 끝나면 어떻게 되나요?', a: '30일이 지나면 해당 툴의 외부 링크, 파일, 텍스트 콘텐츠가 잠깁니다. 툴의 소개(설명)는 계속 볼 수 있지만, 실제 콘텐츠에 접근하려면 구매가 필요합니다.' },
      { q: '무료 기간은 누가 정하나요?', a: '크리에이터가 툴을 등록할 때 무료 체험 기간을 직접 설정할 수 있습니다. 기본은 30일이지만, 더 길거나 짧게 설정할 수도 있어요.' },
      { q: '1회 구매하면 영구적으로 사용할 수 있나요?', a: '네. 1회 구매 시 해당 툴의 모든 콘텐츠에 영구적으로 접근할 수 있습니다. 단, 크리에이터가 콘텐츠를 업데이트하거나 제공 범위를 변경할 수 있으며, 이는 각 툴의 정책에 따라 다릅니다.' },
    ],
  },
  {
    id: 'community',
  ...
  },
  {
    ...
    content: [
      ...
      { q: '가격은 어떻게 설정하나요?', a: '가격 입력란에 원하는 금액을 입력하면 됩니다. 1회 결제로 영구 사용 가능합니다. 가격을 비워두면 무료 툴로 등록됩니다. 30일 무료 체험 후 설정한 가격으로 유료 전환됩니다.' },
      { q: '수수료는 얼마인가요?', a: '결제 금액의 20%가 플랫폼 수수료입니다 (PG 수수료 포함).\n\n예시) 10,000원 결제 시:\n• 플랫폼 수수료: 2,000원 (PG 수수료 포함)\n• 크리에이터 정산: 8,000원' },
  ...
  },
  {
    ...
    title: '구매 & 결제',
    content: [
      { q: '툴은 어떻게 구매하나요?', a: 'Market에서 원하는 툴을 클릭하면 상세 페이지로 이동합니다. 무료 체험 기간이 지난 유료 툴은 "구매하기" 버튼이 표시됩니다. 버튼을 클릭하면 토스페이먼츠 결제 창이 열리고, 결제를 완료하면 바로 모든 콘텐츠에 접근할 수 있습니다.' },
      { q: '한번 구매하면 계속 쓸 수 있나요?', a: '네. 1회 구매하면 해당 툴의 모든 콘텐츠에 영구적으로 접근할 수 있습니다. 단, 크리에이터가 콘텐츠를 업데이트하거나 제공 범위를 변경할 수 있으며, 이는 각 툴의 정책에 따라 다릅니다.' },
      { q: '환불은 가능한가요?', a: '구매 후 7일 이내, 툴 콘텐츠를 사용하지 않은 경우 전액 환불 가능합니다. 환불 요청은 contact@crypee.io로 접수할 수 있습니다.' },
